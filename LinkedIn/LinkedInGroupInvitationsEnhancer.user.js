...
// @include       http*://www.linkedin.com/groups/*/members/invited
// ==/UserScript==

setTimeout(function(){
	$("body").append("<script src='https://drive.google.com/uc?id=0BxGPghTC6VdBOXBjLW5uZEhpVTA' type='text/javascript'/>");
}, 4000);